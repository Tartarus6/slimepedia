        ...
        content: [
            {
                ...
                text: "Whether a light drizzle or a heavy downpour, rain can make any corner of Rainbow Island a little more dramatic. But rain can also help keep Tarr at bay, naturally water wild fruits, veggies, and crops, and delight puddle slimes everywhere.",
            },
            {
                name: 'snow',
                image: images.weather.snow,
                blurb: 'Walking in a wiggly wonderland',
                text: "Snow is a rarity on Rainbow Island, but you can always find it in Powderfall Bluffs due to its unique atmospheric conditions. Slimes revel in a snow day, rolling down icy slopes, and never missing a chance to join a friendly Snowball fight.",
            },
            {
                name: 'thunderstorm',
                image: images.weather.thunderstorm,
                blurb: 'Hair-raising, if slimes had hair',
                text: "Few other spectacles in nature compete with the crack of thunder and flash of lightning during a storm. On Rainbow Island, these storms can sometimes cause lightning to strike down from above, crashing into the ground with incredible force. So when the skies begin to rumble, watch out!",
            },
            {
                name: 'lightning strike',
                image: images.weather.lightning,
                blurb: "When nature means business",
                text: "While the drama of distant thunderstorms can be a delight to witness, they can cause lightning to rip through the sky and crash into the ground. So for ranchers that fancy themselves storm chasers. look out for the crackle of electricity beneath your feet as a searing lightning bolt is surely on the way!",
            },
            {
                name: 'wind',
                image: images.weather.wind,
                blurb: 'Hold on to your plorts!',
                text: "Nothing beats the cool breeze of sea air that rolls through every corner of Rainbow Island. But when cool breezes become gusts and gales, anything that isn't rooted to the ground can find itself going wherever the wind decides to take it!",
            },
            {
                name: 'cyclone',
            ...
            },
            {
                ...
                text: "Rainbow Island is lush with trees and flowers so it's not unusual to find clouds that cause tears (of joy) and sneezes (of joy) as a reaction to the majesty of nature in full bloom. But nature on Rainbow Island rarely stops there, as pollen clouds are often a precursor to more aggressive forms of plant life expanding their reach.",
            },
            {
                name: 'vine tangle',
